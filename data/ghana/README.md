...
|---|---|---|---|---|---|---|---|---|
| [LEAP-1000 household survey](#leap-1000-household-survey-core-restricted) | UNICEF Ghana (proprietary, not public) | Tabular survey | Household + Community | 30 | 26 = 24 household (20 raw + 4 derived) + 2 community (derived from GPS/`hhid`) | 2015, 2017 | 83 KB | ✅ |
...
| [Rainfall / drought exposure](#rainfall--drought-exposure-chirps-via-google-earth-engine) | [CHIRPS](https://developers.google.com/earth-engine/datasets/catalog/UCSB-CHG_CHIRPS_DAILY) (UCSB Climate Hazards Center), via Google Earth Engine | Tabular climate | Community | 1 (daily precip., aggregated to annual) | 5 = 3 pre-treatment climatology (typical level, volatility, drought frequency — candidate treatment-effect modifiers) + 2 realized annual shocks (that year's total, and how far from the community's own average — robustness check only, not a modifier) | 2000–2014 (climatology) and 2015–2017 (realized) | <1 MB | ✅ |
