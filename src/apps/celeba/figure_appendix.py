...
def write_brief(out: Path | None = None) -> None:
    ...
    lines = [
        ...
        "",
        "Linear (default) vs GCM-quadratic vs GCM-LightGBM.",
        "",
        ...
        f"  GCM-LightGBM:      recall≥0.95 at η={sat(e20,'effect_scale','fixed_n',N_MAIN,'NEXIS (test=GCM: lgbm)')}, n={sat(n20,'n','fixed_effect',ETA_MAIN,'NEXIS (test=GCM: lgbm)')}.",
        "",
